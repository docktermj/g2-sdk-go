...
var Messages = map[int]string{
	...
	41:   "Call to G2_getVirtualEntityByRecordID(%s) failed. Return code: %d",
	42:   "Call to G2_getVirtualEntityByRecordID_V2(%s, %d) failed. Return code: %d",
	43:   "Call to G2_howEntityByEntityID(%d) failed. Return code: %d",
	44:   "Call to G2_howEntityByEntityID_V2(%d, %d) failed. Return code: %d",
	45:   "Call to G2_init(%s, %s, %d) failed. Return code: %d",
	46:   "Call to G2_initWithConfigID(%s, %s, %d, %d) failed. Return code: %d",
	47:   "Call to G2_primeEngine() failed. Return code: %d",
	48:   "Call to G2_process(%s) failed. Return code: %d",
	49:   "Call to G2_processRedoRecord() failed. Return code: %d",
	50:   "Call to G2_processRedoRecordWithInfo(%d) failed. Return code: %d",
	51:   "Call to G2_processWithInfo(%s, %d) failed. Return code: %d",
	52:   "Call to G2_processWithResponse(%s) failed. Return code: %d",
	53:   "Call to G2_processWithResponseResize(%s) failed. Return code: %d",
	54:   "Call to PurgeRepository() failed. Return code: %d",
	55:   "Call to G2_reevaluateEntity(%d, %d) failed. Return code: %d",
	56:   "Call to G2_reevaluateEntityWithInfo(%d, %d) failed. Return code: %d",
	57:   "Call to G2_reevaluateRecord(%s, %s, %d) failed. Return code: %d",
	58:   "Call to G2_reevaluateRecordWithInfo(%s, %s, %d) failed. Return code: %d",
	59:   "Call to G2_reinit(%d) failed. Return code: %d",
	60:   "Call to G2_replaceRecord(%s, %s, %s, %s) failed. Return code: %d",
	61:   "Call to ReplaceRecordWithInfo(%s, %s, %s, %s, %d) failed. Return code: %d",
	62:   "Call to G2_searchByAttributes(%s) failed. Return code: %d",
	63:   "Call to G2_searchByAttributes_V2(%s, %d) failed. Return code: %d",
	64:   "Call to G2_stats() failed. Return code: %d",
	65:   "Call to G2_whyEntities(%d, %d) failed. Return code: %d",
	66:   "Call to G2_whyEntities_V2(%d, %d, %d) failed. Return code: %d",
	67:   "Call to G2_whyEntityByEntityID(%d) failed. Return code: %d",
	68:   "Call to G2_whyEntityByEntityID_V2(%d, %d) failed. Return code: %d",
	69:   "Call to G2_whyEntityByRecordID(%s, %s) failed. Return code: %d",
	70:   "Call to G2_whyEntityByRecordID_V2(%s, %s, %d) failed. Return code: %d",
	71:   "Call to G2_whyRecords(%s, %s, %s, %s) failed. Return code: %d",
	72:   "Call to G2_whyRecords_V2(%s, %s, %s, %s, %d) failed. Return code: %d",
